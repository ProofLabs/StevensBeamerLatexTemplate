...
\footlinecolor{stevensmediumgold}
...
\begin{colorblock}[black]{stevenslightorange}{Colour Blocks}
...
\begin{itemize}[<alert@2>]
  ...
  \testcolor{stevensgray}
  \item Secondary Colors are: \testcolor{stevensdarkgray}, \testcolor{stevensdarkblue},\testcolor{stevensmediumblue}, \testcolor{stevensmediumorange}, \testcolor{stevensmediumgold}
  \item Light colors are: 
  \testcolor{stevenslightgray},\testcolor{stevenslightblue}, \testcolor{stevenslightorange}, \testcolor{stevenslightgold}
  \item Other colors are \testcolor{sinteflightgreen}, 
  \testcolor{sintefgreen}, \testcolor{sintefdarkgreen}
